        ...
        return(
            <div className="RPS-Game">
                <div id="RPS-container">
                    ...
                    <RPSPlayer color={"#FF0000"} player={"Computer"} score={this.state.computer.score} play={this.state.computer.play} />
                </div>
                <div id="RPS-button-container">
                    <button className="RPS-button" onClick={() => {this.choosePlayForPlayer("rock") }}>Rock</button>
                    <button className="RPS-button" onClick={() => {this.choosePlayForPlayer("paper") }}>Paper</button>
                    <button className="RPS-button" onClick={() => {this.choosePlayForPlayer("scissors") }}>Scissors</button>
                </div>
            </div>
        )
    }
